...
<div class="wrap">
	...
	<tr valign="top">
		<th scope="row"><label for="legisearch_os_apikey">Open States API Key</label></th>
		<td>
			...
			<?php if( empty( $legisearch_settings->os_apikey ) ) { ?>
				You must register for an Open States API Key for this application by visiting the Open States'
				<a href="https://openstates.org/api/register/" target="_blank">API Registration</a>.
			<?php } ?>
		</td>
	</tr>
	<tr valign="top">
		<th scope="row"><label for="legisearch_os_timeout">Open States Cache Timeout</label></th>
		<td>
