...
All legislative information is pulled from the [Open States API](http://openstates.org) and temporarily cached in your database. If you find that information is incorrect, you should first try clearing the cache in the Settings page. If the information is still incorrect, you may need to wait for Open States to correct the data.
...
1. Settings page. You must at least register an Open States API Key (free) in order for this plugin to work properly.
