...
/*
Copyright 2015-2017 Dan Roberts (email:wp@droberts.us)
...
// Define macros
global $wpdb;
define( 'LEGISEARCH_VERSION', '1.3.2' );
...
define( 'LEGISEARCH__BADAPI_MESSAGE', 'Open States API key is either missing or invalid. Visit the <a href="' . admin_url('admin.php?page=legisearch-settings') . '">Legisearch Settings</a> page.' );
